...
//This module enables users to set the selected data displyed on the segment 



module segment(input clk,
               rst,                          //clock and reset high-active
    ...
    begin
        ...
        seg[16] = 8'b1100_0010;  // G
        seg[17] = 8'b1000_1001;  // H
        seg[18] = 8'b1111_0000;  // I
        seg[19] = 8'b1111_0001;  // J
        seg[20] = 8'b1000_1010;  // K
        seg[21] = 8'b1100_0111;  // L
        seg[22] = 8'b1100_1000;  // M
        seg[23] = 8'b1010_1011;  // N
        seg[24] = 8'b1010_0011;  // O
        seg[25] = 8'b1000_1100;  // P
        seg[26] = 8'b1001_1000;  // Q
        seg[27] = 8'b1100_1110;  // R
        seg[28] = 8'b1011_0110;  // S
        seg[29] = 8'b1000_0111;  // T
        seg[30] = 8'b1100_0001;  // U
        seg[31] = 8'b1110_0011;  // V
        seg[32] = 8'b1000_0001;  // W
        seg[33] = 8'b1001_1011;  // X
        seg[34] = 8'b1001_0001;  // Y
        seg[35] = 8'b1010_0101;  // Z
    end
